...
export const InfoCard = ({ main, label }: InfoCardProps) => {
  return (
    <div
      className="bg-linear-to-b w-full from-(--c-800)/40 to--(--c-900)/20 border border-(--c-600)/30 rounded-xl p-6 sm:p-8 text-center hover:border-(--c-600)/70 transition-colors duration-300"
    >
